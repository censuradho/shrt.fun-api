...
import { base64MaxSize } from '@/shared/helpers/base64MaxSize';
import { sanitizeString } from '@/shared/helpers/sanitizeString';
import { slugNotBanned, slugValidation, urlValidation } from '@/shared/helpers/validations';
import z from 'zod';

const MAX_CENTER_LOGO_SIZE = base64MaxSize(2 * 1024 * 1024); // 2MB

export const qrOptionsDto = z
  .object({
